				...
				{isMediumScreen && (
					<div className="w-full flex justify-between items-center px-4">
						<div className="flex items-center space-x-4">
							...
							<p className="font-semibold text-xl text-white text-[3.12vw] md:text-[20px]">
								SHS Photography Club
							</p>
						</div>
						<img
